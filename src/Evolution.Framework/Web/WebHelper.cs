...
namespace Evolution.Framework
{
    public static class WebHelper
    {
        ...
        {
            var result = WebUtility.UrlEncode(url);
            if (!isUpper)
                return result;
        ...
        {
            return WebHelper.UrlDecode(url);
        }
        ...
        {
            return WebHelper.UrlDecode(url, encoding);
        }
        ...
        //public static void WriteSession<T>(string key, T value,HttpContext _context)
        //{
        //    //if (key.IsEmpty())
        //    //    return;
        ...
        /// <param name="key">Session的键名</param>
        /// <param name="value">Session的键值</param>
        public static void WriteSession(string key, string value,HttpContext contxt)
        {
            byte[] bytes = new byte[value.Length * sizeof(char)];
            Buffer.BlockCopy(value.ToCharArray(), 0, bytes, 0, bytes.Length);
            contxt.Session.Set(key, bytes);
        }
        ...
        /// </summary>
        /// <param name="key">Session的键名</param>        
        public static string GetSession(string key,HttpContext context)
        {
            if (key.IsEmpty()|| context==null)
                return string.Empty;
            byte[] bites = context.Session.Get(key);

            if (bites == null) return string.Empty;
                 
            char[] chars = new char[bites.Length / sizeof(char)];
            System.Buffer.BlockCopy(bites, 0, chars, 0, bites.Length);
        ...
        //public static void WriteCookie(string strName, string strValue, HttpContext context)
        //{
        //    CookieOptions options = new CookieOptions();
        //    options.Path =  "/";
        //    context.Response.Cookies.Append(strName,strValue,options);
        //}
        /// <summary>
        /// 写cookie值
        /// </summary>
        ...
        //public static void WriteCookie(string strName, string strValue, int expires,HttpContext context)
        //{
        //    CookieOptions options = new CookieOptions();
        ...
        //public static string GetCookie(string strName,HttpContext context)
        //{
        //    if (context.Request.Cookies != null && context.Request.Cookies[strName] != null)
        //    {
        //        return context.Request.Cookies[strName].ToString();
        //    }
        //    return "";
        //}
        /// <summary>
        ...
        //public static void RemoveCookie(string CookiesName,HttpContext context)
        //{
        //    CookieOptions options = new CookieOptions();
        //    options.Expires = DateTime.Now.AddYears(-5);
        //    context.Response.Cookies.Append(CookiesName,"",options);
        //}
        #endregion
        ...
        /// </summary>
        public static List<IFormFile> GetFileControls(HttpContext _context)
        {
        ...
        /// 注意:Form标记必须加入属性 enctype="multipart/form-data",服务器端才能获取客户端file控件.
        /// </summary>
        public static IFormFile GetFileControl(HttpContext _context)
        {
            var files = GetFileControls(_context);
